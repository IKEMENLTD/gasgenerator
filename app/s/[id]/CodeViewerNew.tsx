        ...
        <div className="max-w-5xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-lg font-semibold text-gray-900">GAS Code Generator</h1>
                <p className="text-xs text-gray-500">Google Apps Script 自動生成</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="code-container">
              <div className="code-header">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-500 text-xs">{lineCount} lines</span>
                </div>
              </div>
